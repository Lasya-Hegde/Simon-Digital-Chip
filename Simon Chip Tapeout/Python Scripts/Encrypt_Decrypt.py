...
if __name__ == "__main__":
    # Take inputs
    key_hex = input("Enter key in hex (e.g., 1918111009080100): ").strip()
    plaintext_hex = input("Enter plaintext in hex (e.g., 65656877): ").strip()
